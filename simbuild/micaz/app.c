...
#line 131
{
  ...
  sim_log_debug(174U, "radio_rec", "Message received at time %s \n", sim_time_string());
  ...
  sim_log_debug_clear(179U, "radio_pack", "\t\t Payload \n");
  sim_log_debug_clear(180U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(projectC$mess[sim_node()]->msg_type.nxdata));
  sim_log_debug_clear(181U, "radio_pack", "\t\t msg_id: %hhu \n", __nesc_ntoh_uint16(projectC$mess[sim_node()]->msg_id.nxdata));
  sim_log_debug_clear(182U, "radio_pack", "\t\t destination address: %hhu \n", __nesc_ntoh_uint8(projectC$mess[sim_node()]->dst_add.nxdata));
  sim_log_debug_clear(183U, "radio_pack", "\t\t source address: %hhu \n", __nesc_ntoh_uint8(projectC$mess[sim_node()]->src_add.nxdata));

  sim_log_debug_clear(184U, "radio_pack", "\n");
#line 209
  return buf;
}
...
#line 93
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(169U, "radio", "Radio %d on!\n", TOS_NODE_ID);
      if (TOS_NODE_ID) {
          sim_log_debug(170U, "role", "I'm node %d: start sending periodical request\n", TOS_NODE_ID);
...
# 83 "/home/user/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40b73cf8){
#line 83
  switch (arg_0x40b73cf8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40b73cf8);
#line 83
      break;
#line 83
    }
